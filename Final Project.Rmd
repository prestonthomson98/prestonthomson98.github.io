...
Our Null Hypothesis for this experiment is that the factors tested will not affect death rate on May 04, 2020.  None of the factors tested showed a p-value greater than .05, so we cannot reject the null hypothesis.  The regression model shows that bed_usage, restrictions, and death rate on March 29 are not statistically significant for predicting death rates on May 4.  
